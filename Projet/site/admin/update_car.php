<?
    ...
    $GetMyCard = $BDD->prepare('SELECT * FROM cartes WHERE valide = 1 ORDER by createur DESC');
...
?>
        ...
        <h2 class="hredac"> Bienvenue <?php echo $user; ?> dans la gestions des cartes </h2>
        <h3 class="hredac"> Voici la liste des cartes existantes choisissez ce que vous voulez faire ! </h3>
        <table class="tabadmin" style="width: 75%; height: 75px;">
            <tbody>
                <tr>
                    ...
                    <td style="width: 15%;" class="tdredac">Auteur</td>
                ...
                <?php foreach ($resultat_card as $row){?>
                    <tr>
                        ...
                        <td style="width: 15%;" class="tdredacq"><?echo $row['createur']; ?></td>
