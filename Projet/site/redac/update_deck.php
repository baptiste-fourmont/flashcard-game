<?php 
    ...
    */ 
    ...
    if(!is_redac()){
     ...
     $data = $BDD->prepare('UPDATE deck SET q1 = :q1, q2 = :q2, q3 = :q3, q4 = :q4, q5 = :q5, q6 = :q6, q7 = :q7, q8 = :q8, q9 = :q9, q10 = :q10, valide = 1, difficulte = :difficulte WHERE nomdeck = :nomdeck AND nom = :nom');
